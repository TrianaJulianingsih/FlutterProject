...
CharacterModel welcomeFromJson(String str) =>
    CharacterModel.fromJson(json.decode(str));

String welcomeToJson(CharacterModel data) => json.encode(data.toJson());

class CharacterModel {
  Pagination? pagination;
  List<Datum>? data;

  CharacterModel({this.pagination, this.data});
