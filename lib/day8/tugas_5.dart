...
class _Day8StateState extends State<TugasLima> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Halaman Interaktif Pengguna"), 
                  ...
                  children: [
                    IconButton(
                      ...
                      icon: Icon(Icons.favorite, 
                        color: favoriteIcon? const Color.fromARGB(255, 255, 7, 7): Colors.blueGrey
                      ),
                    ),
                    favoriteIcon? 
                    Text(tampilFavorite, 
                ...
                Column(
                  children: [
                    TextButton(
                      ...
                      child: Text(selengkapnya ? "Lihat Selengkapnya" : "Lihat Selengkapnya"),
                      
                    ),
                    selengkapnya? Text("Saya sedang belajar mobile programming", 
                      style: TextStyle(
                      fontSize: 16,
                      fontFamily: "Lobster",
                      color: const Color.from(alpha: 1, red: 0.486, green: 0.302, blue: 1)
                      )
                    ): 
                    SizedBox(),
